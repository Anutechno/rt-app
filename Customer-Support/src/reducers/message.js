  ...
  messages: [
    {
      ...
      from: "support agent",
      fromTo: "CS_12",
      subject: "Transfered Chat session-CH123456789",
    ...
    case DELETE_MESSAGES:
      return {
        ...
        messages: state.messages.filter(
          (msg) => payload.msgIds.findIndex((m) => m === msg.id) === -1
        ),
      };
    case MOVE_TO:
      return {
        ...
        messages: state.messages.map((msg, index) =>
          payload.msgIds.findIndex((m) => m === msg.id) !== -1
            ? { ...msg, location: payload.to }
            : msg
        ),
      };
    default:
